...
const items: NavItem[] = [
  { path: '/grocery', label: 'Need', icon: ShoppingBag },
  { path: '/grocery/planning', label: 'Planning', icon: Calendar },
]

function renderNav(placement: 'bottom' | 'rail', currentPath = '/grocery') {
  return render(
    <MemoryRouter>
...
describe('AppNav', () => {
  ...
  it('marks the current destination for assistive tech', () => {
    renderNav('bottom', '/grocery/planning')
